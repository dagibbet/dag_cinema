...
Citizen.CreateThread(function()
	exports['qbr-core']:createPrompt('saint_denis_cin', vector3(2541.56, -1282.03, 49.27), 0x760A9C6F, 'Theatre Menu', {
            type = 'client',
            event = 'dag_cinema:client:menu',
            args = {},
        })
	exports['qbr-core']:createPrompt('annesburg_cinr', vector3(-348.57, 701.97, 117.68), 0x760A9C6F, 'Cinema Menu', {
            type = 'client',
            event = 'dag_cinema:client:menu',
            args = {},
        })
	exports['qbr-core']:createPrompt('blackwater_cin', vector3(-788.55, -1362.62, 44.58), 0x760A9C6F, 'Cinema Menu', {
            type = 'client',
            event = 'dag_cinema:client:menu',
            args = {},
        })
...
RegisterNetEvent("dag_cinema:startShow")
AddEventHandler("dag_cinema:startShow", function(show)
...
RegisterNetEvent("dag_cinema:startShow1")
AddEventHandler("dag_cinema:startShow1", function(showname)
	StartShow(showname)	
end)

RegisterNetEvent("dag_cinema:startShow2")
AddEventHandler("dag_cinema:startShow2", function(showname)
	local city = GetCurrentTownName()

	StartShow("MOVIE", city, showname)	
end)
...
RegisterNetEvent('dag_cinema:client:menu')
AddEventHandler('dag_cinema:client:menu', function()
	exports['qbr-menu']:openMenu({
        ...
        },
        {
            ...
            txt = "Show Menu",
            params = {
                event = 'dag_cinema:client:menuShows',
				isServer = false,
            }
        },
		{
            ...
            txt = "Moving Pictures",
            params = {
                event = 'dag_cinema:client:menuMovies',
				isServer = false,
            }
        },
        {
...
RegisterNetEvent('dag_cinema:client:menuShows')
AddEventHandler('dag_cinema:client:menuShows', function()
	local city = GetCurrentTownName()
	if city == "SAINTDENIS" then 
		exports['qbr-menu']:openMenu({
			{
				header = "| Shows |",
				isMenuHeader = true,
			...
			},
			{
				...
				txt = "More Shows",
				params = {
					event = 'dag_cinema:client:menuShows2',
					isServer = false,
		...
		exports['qbr-core']:Notify(8, 'Only Available in Saint Denis!', 5000, '', 'itemtype_textures', 'itemtype_player_deadeye', 'COLOR_GREEN')
	end
end)

RegisterNetEvent('dag_cinema:client:menuShows2')
AddEventHandler('dag_cinema:client:menuShows2', function()
...
RegisterNetEvent('dag_cinema:client:menuMovies')
AddEventHandler('dag_cinema:client:menuMovies', function()
	...
	exports['qbr-menu']:openMenu({
		...
		{
            header = "Secret of Manflight",
            txt = "The future is now",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "SECRET_OF_MANFLIGHT"
				
            }
        },
		{
            header = "Saviors and Savages",
            txt = "A trip around the world",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "SAVIORS_AND_SAVAGES"
		...
		{
            header = "Direct current Damnation",
            txt = "Horror story",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "DIRECT_CURRENT_DAMNATION"
				
            }
        },
		{
            header = "Movie List Page 2",
            txt = "More Movies",
            params = {
                event = 'dag_cinema:client:menuMovies2',
				isServer = false,
...
RegisterNetEvent('dag_cinema:client:menuMovies2')
AddEventHandler('dag_cinema:client:menuMovies2', function()
	...
	exports['qbr-menu']:openMenu({
        ...
        {
            header = "Farmers Daughter",
            txt = "Farmers Daughter",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "FARMERS_DAUGHTER"
				
            }
        },
		{
            header = "Modern Medicine",
            txt = "Modern Medicine",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "MODERN_MEDICINE"
				
            }
        },
		{
            header = "Worlds Strongest Man",
            txt = "Strong Man",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "WORLDS_STRONGEST_MAN"
				
            }
        },
		{
            header = "Sketching for Sweetheart",
            txt = "Sketching for Sweetheart",
            params = {
                event = 'dag_cinema:startShow2',
				isServer = false,
				
					args = "SKETCHING_FOR_SWEETHEART"
